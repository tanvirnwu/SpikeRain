...
parser.add_argument('--model_version', default='M', type=str) 
parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. -1 for CPU')
parser.add_argument('--data_path', type=str, default="/home/tanvir/datasets/img_restoration/deraining/rain1400/test/input")
parser.add_argument('--save_path', type=str, default="/home/tanvir/projects/img_restoration/sota/ESDNet/output/dense_attn_FRB22")
...
if __name__ == '__main__':
    ...
    model_factory = SpikeRainFactory(opt.T)
    SpikeRain = model_factory.get_model(opt.model_version)
    model_utils.model_size(SpikeRain, opt.T, opt.model_version)
    ...
    # ? Call checkpoint loading here, AFTER model definition
