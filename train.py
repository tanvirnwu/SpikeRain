...
if __name__ == "__main__":
    ...
    parser.add_argument('--warmup_epochs', default=5, type=int, help='warmup_epochs')
    ...
    ######### Model ###########
    model_factory = SpikeRainFactory(args.T)
    SpikeRain = model_factory.get_model(args.version)
    model_utils.model_size(SpikeRain, args.T, args.version)
